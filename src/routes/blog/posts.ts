...
const posts: post[] = [
	{
		...
		description: `<p class="">AI has been here for a while. It changed how we work and how we think. So many people use it everyday, but at what cost?</p><p class="">Are we losing our own opinions? And what about cognitive thought?</p><p class=""><strong>Today I am writing about using AI less and the benefits I see from it.</strong></p>
`,
		cleanDescription: `AI has been here for a while. It changed how we work and how we think. So many people use it everyday, but at what cost? Are we losing our own opinions? And what about cognitive thought? Today I am writing about using AI less and the benefits I see from it.`,
