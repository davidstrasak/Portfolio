import{a as O,t as R}from"../chunks/ByeDYjpv.js";import{at as V,R as z,i as F,p as G,au as J,av as N,f as Q,t as U,a as X,s as c,a8 as k,g as n,c as l,r as m,aw as P}from"../chunks/DRdpxGBI.js";import{s as B}from"../chunks/HSoiMXZw.js";import{h as Y}from"../chunks/BWqcOX4Q.js";import{a as Z,r as L,b as tt,c as M,s as et}from"../chunks/Db2Wpu7f.js";import{e as rt}from"../chunks/DjrZec-h.js";import{b as at}from"../chunks/C2xV41CC.js";import{i as st}from"../chunks/Cr191pCV.js";import{b as ot}from"../chunks/ClR-pdl8.js";import{o as A}from"../chunks/CyWDKHde.js";function pt(e,s,o,p=o){e.addEventListener(s,o);const r=e.__on_r;r?e.__on_r=()=>{r(),p()}:e.__on_r=p,Z()}function nt(e,s,o=s){var p=V();pt(e,"input",()=>{var r=C(e)?D(e.value):e.value;o(r),p&&r!==(r=s())&&(e.value=r??"")}),z(()=>{var r=s();if(F&&e.defaultValue!==e.value){o(e.value);return}C(e)&&r===D(e.value)||e.type==="date"&&!r&&!e.value||r!==e.value&&(e.value=r??"")})}function C(e){var s=e.type;return s==="number"||s==="range"}function D(e){return e===""?null:+e}var it=R(`<form method="post" action="?/save"><input type="hidden" name="html"> <input type="hidden" name="path"></form> <p>Currently editing: <span class="text-primary font-systemancer"> </span>, on the
