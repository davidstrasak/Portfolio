import{a as q,t as O}from"../chunks/Cy94rl3v.js";import{at as R,R as V,i as Y,p as z,au as F,av as G,f as J,t as N,a as Q,s as c,a8 as $,g as p,c as l,r as m,aw as k}from"../chunks/DRdpxGBI.js";import{s as P}from"../chunks/Dxv1kZdi.js";import{h as U}from"../chunks/BaCF-LQC.js";import{a as X,r as S,b as Z,c as T}from"../chunks/Db2Wpu7f.js";import{e as tt}from"../chunks/DjrZec-h.js";import{b as et}from"../chunks/C2xV41CC.js";import{i as rt}from"../chunks/Cr191pCV.js";import"../chunks/Dkp0L1Vf.js";import{o as A}from"../chunks/CyWDKHde.js";function at(e,s,o,n=o){e.addEventListener(s,o);const r=e.__on_r;r?e.__on_r=()=>{r(),n()}:e.__on_r=n,X()}function st(e,s,o=s){var n=R();at(e,"input",()=>{var r=C(e)?D(e.value):e.value;o(r),n&&r!==(r=s())&&(e.value=r??"")}),V(()=>{var r=s();if(Y&&e.defaultValue!==e.value){o(e.value);return}C(e)&&r===D(e.value)||e.type==="date"&&!r&&!e.value||r!==e.value&&(e.value=r??"")})}function C(e){var s=e.type;return s==="number"||s==="range"}function D(e){return e===""?null:+e}var ot=O(`<form method="post" action="?/save"><input type="hidden" name="html"> <input type="hidden" name="path"></form> <p>Currently editing: <span class="text-primary font-systemancer"> </span>, on the
